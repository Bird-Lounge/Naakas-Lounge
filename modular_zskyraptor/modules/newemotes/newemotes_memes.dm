...
/datum/emote/living/snake_scream/get_sound(mob/living/user)
	return pick('modular_zskyraptor/modules/newemotes/sounds/snake_fucking_died.ogg')
...
/datum/emote/living/snake_scream/jc/get_sound(mob/living/user)
	return pick('modular_zskyraptor/modules/newemotes/sounds/jc_fucking_died.ogg')
...
/datum/emote/living/snake_scream/teshi/get_sound(mob/living/user)
	return pick('modular_zskyraptor/modules/newemotes/sounds/teshi_fucking_died.ogg')
...
/datum/emote/living/snake_scream/lizzer/get_sound(mob/living/user)
	return pick('modular_zskyraptor/modules/newemotes/sounds/lizzer_fucking_died.ogg')
...
/datum/emote/living/snake_scream/haki/get_sound(mob/living/user)
	return pick('modular_zskyraptor/modules/newemotes/sounds/haki_fucking_died.ogg')
...
/datum/emote/living/snake_scream/moff/get_sound(mob/living/user)
	return pick('modular_zskyraptor/modules/newemotes/sounds/moff_fucking_died.ogg')
...
/datum/emote/living/snake_scream/scug/get_sound(mob/living/user)
	return pick('modular_zskyraptor/modules/newemotes/sounds/sluggony2.ogg')

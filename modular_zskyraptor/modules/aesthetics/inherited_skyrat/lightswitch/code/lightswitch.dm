/obj/machinery/light_switch
	icon = 'modular_zskyraptor/modules/aesthetics/inherited_skyrat/lightswitch/icons/lightswitch.dmi'

/obj/machinery/light_switch/interact(mob/user)
	. = ..()
	playsound(src, 'modular_zskyraptor/modules/aesthetics/inherited_skyrat/lightswitch/sound/lightswitch.ogg', 100, 1)

...
/datum/greyscale_config/handheld_atmos_tank
	...
	icon_file = 'modular_zskyraptor/modules/aesthetics/moremospherics/icons/atmosia_items.dmi'
	json_config = 'modular_zskyraptor/modules/aesthetics/moremospherics/greyscales/tank_inventory.json'

/datum/greyscale_config/handheld_atmos_tank/worn
	name = "Worn Atmos Tank"
	icon_file = 'modular_zskyraptor/modules/aesthetics/moremospherics/icons/atmosia_items_suit.dmi'
	json_config = 'modular_zskyraptor/modules/aesthetics/moremospherics/greyscales/tank_mob.json'

/datum/greyscale_config/handheld_atmos_tank/worn/held_l
	name = "Left Held Atmos Tank"
	icon_file = 'modular_zskyraptor/modules/aesthetics/moremospherics/icons/atmosia_items_lh.dmi'
	json_config = 'modular_zskyraptor/modules/aesthetics/moremospherics/greyscales/tank_held.json'

/datum/greyscale_config/handheld_atmos_tank/worn/held_r
	name = "Right Held Atmos Tank"
	icon_file = 'modular_zskyraptor/modules/aesthetics/moremospherics/icons/atmosia_items_rh.dmi'
	json_config = 'modular_zskyraptor/modules/aesthetics/moremospherics/greyscales/tank_held.json'

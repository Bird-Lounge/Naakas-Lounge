...
/atom/movable/screen/plane_master/rendering_plate/game_plate/Initialize(mapload, datum/hud/hud_owner)
	...
	//if(check_holidays(HALLOWEEN))
		...
		//add_filter("spook_color", 2, color_matrix_filter(list(0.75,0.13,0.13,0, 0.13,0.7,0.13,0, 0.13,0.13,0.75,0, -0.06,-0.09,-0.08,1, 0,0,0,0))) /// NAAKAS-LOUNGE REMOVAL: FUCK THIS GRUNGE-ASS FILTER

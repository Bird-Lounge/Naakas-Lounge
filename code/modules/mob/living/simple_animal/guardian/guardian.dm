...
/mob/living/simple_animal/hostile/guardian/update_health_hud()
	...
	if(hud_used?.healths)
		hud_used.healths.maptext = MAPTEXT_MNC("<div align='center' valign='middle' style='position:relative; top:0px; left:6px'><font color='#efeeef'>[round(healthpercent, 0.5)]%</font></div>") /// NAAKAS-LOUNGE EDIT: MNC Maptext

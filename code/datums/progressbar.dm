...
/datum/progressbar/New(mob/User, goal_number, atom/target, starting_amount)
	...
	bar = image('modular_zskyraptor/modules/aesthetics/ui_greenened/hud/progressbar.dmi', bar_loc, "prog_bar_0", pixel_x = offset_x) /// NAAKAS-LOUNGE EDIT: switching to our progressbar

...
/obj/item/healthanalyzer/interact_with_atom(atom/interacting_with, mob/living/user, list/modifiers)
	...
	if ((HAS_TRAIT(user, TRAIT_CLUMSY) || HAS_TRAIT(user, TRAIT_DUMB)) && prob(50))
		...
		/// NAAKAS-LOUNGE EDIT: custom colors
		to_chat(user, "[span_info("Analyzing results for The floor:<br>\tOverall status: <b>Healthy</b>")]\
				<br>[span_info("Key: <font color='#0066ff'>Suffocation</font>/<font color='#aaff00'>Toxin</font>/<font color='#ff6600'>Burn</font>/<font color='#6600ff'>Brute</font>")]\
				<br>[span_info("\tDamage specifics: <font color='#0066ff'>0</font>-<font color='#aaff00'>0</font>-<font color='#ff6600'>0</font>-<font color='#6600ff'>0</font>")]\
			...
			if(mode == SCANNER_VERBOSE)
				for(var/obj/item/bodypart/limb as anything in damaged)
					if(limb.bodytype & BODYTYPE_ROBOTIC)
						dmgreport += "<tr><td><font color='#ff0000'>[capitalize(limb.name)]:</font></td>" /// NAAKAS-LOUNGE EDIT
					else
						dmgreport += "<tr><td><font color='#ff0000'>[capitalize(limb.plaintext_zone)]:</font></td>" /// NAAKAS-LOUNGE EDIT
					dmgreport += "<td><font color='#6600ff'>[(limb.brute_dam > 0) ? "[CEILING(limb.brute_dam,1)]" : "0"]</font></td>" /// NAAKAS-LOUNGE EDIT
					dmgreport += "<td><font color='#ff6600'>[(limb.burn_dam > 0) ? "[CEILING(limb.burn_dam,1)]" : "0"]</font></td></tr>" /// NAAKAS-LOUNGE EDIT
